...
namespace WestWindSystem.BLL
{
    public class ShipmentServices
    {
        ...
        // These are the methods needed to do paging on the web page
        ...
        public List<Shipment> Shipment_GetByYearandMonthPaging(int year, int month, int currentPageNumber, int itemsperpage)
        {
