...
namespace OOPsReview
{
    public class Employment
    {
        ...
        public Employment()
        {
            ...
            // you may wish to have someother value than the default

            Title = "Unknown"; //Title cannot be null, empty or blank; cannot use the default
            StartDate = DateTime.Today; // a date of 01/01/0001 is not reasonable for the application
                            ...
                            DateTime startdate, double years = 0.0)
        {
            ...
            else
            {
                ...
                {
                    //determined that the number of employeed years needs to
                    // be calculate
        ...
        public static Employment Parse(string line)
        {
            ...
            //test that the proper amount of data is on the line
            //when we create the instance, the class internal validation will
            //  validate the data is correct
            if (datavalues.Length != 4) 
            {
                //any number of data values NOT equal to 4 indicates a corrupted record
                //this record should not be processed and an exception thrown
            ...
            return new Employment(datavalues[0], //SUP I
                                    (SupervisoryLevel)Enum.Parse(typeof(SupervisoryLevel), datavalues[1]), //Supervisor
                                    DateTime.Parse(datavalues[2]), //Apr 01 2025
                                    double.Parse(datavalues[3])); //0.5
